...
{
    public class SqlServerAggrQuerySqlParser : IAggrQuerySqlParser
    {
        ...
        private string ToSql(AggrCriterion aggrCriterion)
        {
            ...
            return string.Format("ISNULL({0}({1}{2}),0) {3}", oper, aliasName, aggrCriterion.PropertyName, aggrCriterion.ResultPropertyName);
        }
